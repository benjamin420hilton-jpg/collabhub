        ...
        <div className="relative space-y-8">
          <div className="space-y-4">
            <h1 className="text-4xl font-bold leading-tight tracking-tight xl:text-5xl">
              Welcome back to the creator marketplace.
            </h1>
            <p className="text-lg text-white/70">
              Sign in to manage collaborations, track campaigns, and get paid — all in one place.
            </p>
          </div>

          <ul className="space-y-4">
            {[
              { icon: Users, label: "Connect with thousands of vetted creators and brands" },
              { icon: Shield, label: "Contracts, escrow and payouts handled for you" },
              { icon: TrendingUp, label: "Real performance data — no vanity metrics" },
            ].map(({ icon: Icon, label }) => (
