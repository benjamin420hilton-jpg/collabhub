  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2">
      <form action={selectRole}>
        ...
        <Card className="card-hover cursor-pointer border-border/60 animate-fade-in-up delay-100">
      ...
      <form action={selectRole}>
        ...
        <Card className="card-hover cursor-pointer border-border/60 animate-fade-in-up delay-200">
          <CardHeader className="text-center">
            <div className="mx-auto mb-2 flex size-14 items-center justify-center rounded-2xl bg-violet-light">
            ...
            <CardDescription>
              Find brand deals, showcase your content, and grow your career.
              100% free.
            </CardDescription>
          </CardHeader>
          <CardContent>
